...
# Input: environmental_data_light_RDA, microeco_prok.Rdata, microeco_euk.Rdata, microeco_prok_euk.Rdata
# Main output: Figure_6_a.jpeg, Figure_6_b.jpeg, Figure_6_c.jpeg

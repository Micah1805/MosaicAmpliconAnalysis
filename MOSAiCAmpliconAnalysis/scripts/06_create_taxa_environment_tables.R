...
####Taxa tables####
#Clean taxa tables prokaryotes and eukaryotes
#Load data
#prok_taxa <- load("MosaicAMpliconAnalysis/data/taxonomy_prokaryotes.csv")
euk_taxa <- load("MosaicAMpliconAnalysis/data/taxonomy_eukaryotes.csv")
...
write.csv(euk_taxa,file="MosaicAMpliconAnalysis/outputs/taxonomy_eukaryotes_clean.csv", row.names=TRUE)



####Environmental data####
#Load data
Water_sort_Prok <- load("MosaicAMpliconAnalysis/outputs/asv_categorised_prokaryotes.csv")
...
Water_sort_Euk <- load("MosaicAMpliconAnalysis/outputs/asv_categorised_eukaryotes.csv")
...
#save(Env_Prok,file="MosaicAMpliconAnalysis/outputs/environmental_data_prokaryotes.Rdata")
write.csv(Env_Prok,file="MosaicAMpliconAnalysis/outputs/environmental_data_prokaryotes.csv", row.names=TRUE)
...
write.csv(Env_Euk,file="MosaicAMpliconAnalysis/outputs/environmental_data_eukaryotes.csv", row.names=TRUE)
...
write.csv(Env_Euk_Prok,file="MosaicAMpliconAnalysis/outputs/environmental_data_prokaryotes_eukaryotes.csv", row.names=TRUE)

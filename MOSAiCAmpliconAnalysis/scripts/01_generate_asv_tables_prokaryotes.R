...
################################################################################
######Generate amplicon sequence (ASV) tables for prokaryotes using DADA2#######
################################################################################
...
path="C:/Users/jahuem001/OneDrive/Dokumente/AWI/MOSAiC/Sequencing_Prok_Euk/Fastqs/Proks/Water_only"
#set software pathes
...
#(each directory contains forward and reverse 16S FASTq reads)
#<time_stamp>_<seq_run>
#example: "2020-10-27_13-31-04_M03457_0049_000000000-CRH8D"
runID.1 <- file.path(path,"/M03457_0098_000000000-JV7PW")
#runID.2 <- file.path(path,"/M03457_0099_000000000-K3N58")
#runID.3 <- file.path(path,"/M03457_0100_000000000-K3NB9")
#runID.4 <- file.path(path,"/M03457_0104_000000000-K55KY")

runs<-list(runID.1)
           #,runID.2,runID.3,runID.4)
...
#### TAXA assignmennt####
#Data for taxonomy and species assignment need to be downlowded from Silva and
#stored locally (whwn not working on a server)
taxa <- assignTaxonomy(seqtab.nochim, 
"C:/Users/jahuem001/OneDrive/Dokumente/AWI/MOSAiC/Sequencing_Prok_Euk/Fastqs/Proks/Silva/silva_nr99_v138.1_train_set.fa.gz", 
multithread=TRUE)

taxa <- addSpecies(taxa, 
"C:/Users/jahuem001/OneDrive/Dokumente/AWI/MOSAiC/Sequencing_Prok_Euk/Fastqs/Proks/Silva/silva_species_assignment_v138.1.fa.gz")
...
save(abundMatRaw,file=paste0(temp_dir,"/RawAbundanceMat.Rdata"))

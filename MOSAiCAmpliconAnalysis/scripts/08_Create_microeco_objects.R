...
#        asv_norm_prokaryotes_eukaryotes.csv, taxonomy_prokaryotes_eukaryotes.csv, environmental_data_prokaryotes_eukaryotes.csv
# Main output: microeco_prok.Rdata, microeco_euk.Rdata, microeco_prok_euk.Rdata

...
Env_Meta <- read_excel("MosaicAMpliconAnalysis/data/environmental_metadata.xlsx",
...
#save(Env_tot,file=MosaicAMpliconAnalysis/outputs/environmental_data_depths.Rdata"))
write.csv(Env_tot,file="MosaicAMpliconAnalysis/outputs/environmental_data_depths.csv", row.names=TRUE)
...
#save(Env_mean,file="MosaicAMpliconAnalysis/outputs/environmental_data_mean.Rdata")
write.csv(Env_mean,file="MosaicAMpliconAnalysis/outputs/environmental_data_mean.csv", row.names=TRUE)


####Add Light to the environmental data####

#Load data and modify it
Light <- read_excel("MosaicAMpliconAnalysis/data/Light.xlsx")
...
#save(Env_tot_Light_m,file="MosaicAMpliconAnalysis/outputs/environmental_data_light.Rdata")
write.csv(Env_tot_Light_m,file="MosaicAMpliconAnalysis/outputs/environmental_data_light.csv", row.names=TRUE)
...
#save(Env_tot_Light_m_2,file="MosaicAMpliconAnalysis/outputs/environmental_data_light_2.Rdata")
write.csv(Env_tot_Light_m_2,file="MosaicAMpliconAnalysis/outputs/environmental_data_light_2.csv", row.names=TRUE)


#save(Env_tot_Light_m_1,file="MosaicAMpliconAnalysis/outputs/environmental_data_light_RDA..Rdata")
write.csv(Env_tot_Light_m_1,file="MosaicAMpliconAnalysis/outputs/environmental_data_light_RDA.csv", row.names=TRUE)

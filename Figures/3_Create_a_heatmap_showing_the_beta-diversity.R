################################################################################
#################Create a heatmap showing the beta-diversity####################
################################################################################
...
Beta_m <- Beta %>% group_by(Category) %>% summarise(across(c(4:92),mean)) %>% distinct 
...
Beta_m_t <- Beta_t %>% group_by(Category) %>% summarise(across(c(3:6),mean)) %>% distinct 
...
Beta_sort_m <- Beta_sort %>% group_by(Category_Leg) %>% summarise(across(c(5:95),mean)) %>% distinct 
...
Beta_sort_t_m <- Beta_sort_t %>% group_by(Category_Leg) %>% summarise(across(c(5:24),mean)) %>% distinct 
